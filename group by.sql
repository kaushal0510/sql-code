...
select title,author_fname,author_lname, released_year,count(*) from books group by released_year order by released_year desc;
select concat(
'in ', released_year,' ',count(*),' ','book released.'
